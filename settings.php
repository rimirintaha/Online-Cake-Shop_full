					...
					<div class="holecontainer" style=" padding-top: 20px; padding: 0 20%">
						<form action="" method="POST" class="registration">
							<div class="container signupform_content ">
								...
								<div>
									<tr><input style="border: 1px solid  #154360 ;" class="email signupbox"
											type="password" name="npass1" placeholder="Repeat Password"></tr>
									</br></br></br></br></br>
								</div>
								<div style="font-size: 20px;color:  #1b4f72 ;margin: 0 0 5px 0;">
								...
								<div>
									<tr><?php echo '<input style="border: 1px solid  #154360 ;" class="email signupbox" required type="email" name="email" placeholder="New Email" value="' . $uemail_db . '">'; ?>
									</tr></br>
								</div>
								<div>
