						...
						<div>
							<form action="" method="POST" class="registration">
								<div class="signup_form">
									<div>
										<td>
											<input type="text" name="username" class="email signupbox"
												placeholder="Write  Email..." size="30" required autofocus>
										</td>
									</div>
									<div>
										<input class="uisignupbutton signupbutton" type="submit" name="searchId"
											id="senddata" value="Search">
									</div>
