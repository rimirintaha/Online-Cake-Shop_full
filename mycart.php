...
<body style="background-image: url(image/homebackgrndimg1.jfif);">
	...
	<div class="categolis">
		<table>
			<tr>
				<th><?php echo '<a href="mycart.php?uid=' . $user . '" style="text-decoration: none;color: #040403;padding: 4px 12px;background-color: #e6b7b8;border-radius: 12px;">My Cart</a>'; ?>
				</th>
				<th>
				...
				<div>
					<div style="">
						...
						if (isset($success_message)) {
							...
							echo '<h3 style="color:#169E8F;font-size:35px;"> Total: TK ' . $_SESSION['total'] . ' TK</h2>';
