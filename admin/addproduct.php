									...
									<div class="signupform_content">
										...
										<div>
  											...
  											<h5>Item:</h5>
												...
												<select name="item" required="required" style=" font-size: 20px;
														font-style: italic;margin-bottom: 3px;margin-top: 0px;padding: 14px;line-height: 25px;border-radius: 4px;border: 1px solid #169E8F;color: #169E8F;margin-left: 195px;width: 300px;background-color: transparent;" class="">
																<option selected value="chocholate">Chocholate</option>
											...
											<input name="signup"  style=" font-size: 20px;
														font-style: italic;margin-bottom: 3px;margin-top: 0px;padding: 14px;line-height: 25px;border-radius: 4px;border: 1px solid #169E8F;color: #ffff;margin-left: 260px;width: 304px;background-color: green;" class="uisignupbutton signupbutton" type="submit" value="Add Product">
											</div>
											</div>
											</form>
