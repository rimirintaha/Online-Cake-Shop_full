...
<body>
	...
	<div class="categolis">
		<table>
			<tr>
				...
				<th><a href="mango.php" style="text-decoration: none;color: #040403;padding: 4px 12px;background-color:#24bfae;border-radius: 12px;">Mango</a></th>
	...
	<div style="padding: 15px 0px; font-size: 15px; margin: 0 auto; display: table; width: 98%;">
		<div>
		<?php 
			$getposts = mysqli_query($con, "SELECT * FROM products WHERE item ='mango'  ORDER BY id DESC LIMIT 10") or die(mysqlI_error($con));
							...
							<ul style="float: left;">
								<li style="float: left; padding: 0px 25px 25px 25px;">
									<div class="home-prodlist-img"><a href="view_product.php?pid='.$id.'">
										<img src="../image/product/mango/'.$picture.'" class="home-prodlist-imgi">
										</a>
